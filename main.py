...
ui_texts = {
    "English": {
        ...
        "sms_fail": "⚠️ SMS alert failed. Please check Twilio configuration."
    },
    "Hindi": {
        ...
        "sms_fail": "⚠️ एसएमएस अलर्ट विफल। कृपया ट्विलियो सेटिंग जांचें।"
    },
    "Telugu": {
        ...
        "sms_fail": "⚠️ SMS హెచ్చరిక విఫలమైంది. దయచేసి Twilio కాన్ఫిగరేషన్ తనిఖీ చేయండి."
    }
}
...
if analyze:
    ...
    if weather_data and "current" in weather_data:
        ...
        st.metric("🌡️ Temp", f"{cur.get('temp')}°C")
    ...
    # 📲 SMS Alert Dispatch
    local_contacts = ["+916301475493", "+919959300894"]  # Replace dynamically
...
if st.session_state.advice:
    ...
    <div style="background:rgba(255,255,255,0.95);
        ...
        <p style="color:gray;font-size:0.8rem;text-align:right;">⏱️ {st.session_state.generated_time}</p>
    </div>
